...
function [Br, Bt, Ct, Dr, Dt, Et, alpha__r, alpha__t, alpha__t__eq, alpha__r__eq, s] = MF96_MZ_coeffs(kappa, alpha, phi, Fz, tyre_data, road_condition)
 ...
 % precode
  ...
  lambda__mu__y   = tyre_data.lambda__mu__y * road_condition;
  ...
  if sSz1 ~= 0
  	 fy = MF96_FY(kappa, alpha, phi, Fz, tyre_data, road_condition);
  else
  	 fy = 0;
  end
  
  [alpha__y, By, Cy, Dy, Ey, SVy, Kya, SHy] = MF96_FY0_coeffs(kappa, alpha, phi, Fz, tyre_data, road_condition);
  [kappa__x, Bx, Cx, Dx, Ex, SVx, Kxk] = MF96_FX0_coeffs(kappa, alpha, phi, Fz, tyre_data, road_condition);
