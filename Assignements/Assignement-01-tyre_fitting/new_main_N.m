...
ALPHA_tol_x_dalpha = 0.05*to_rad;
idx_x_dalpha.ALPHA_0 = 0.0*to_rad-ALPHA_tol_x_dalpha < TData_x_dalpha.IA & TData_x_dalpha.IA < 0.0*to_rad+ALPHA_tol_x_dalpha;
idx_x_dalpha.ALPHA_3 = 3.0*to_rad-ALPHA_tol_x_dalpha < TData_x_dalpha.IA & TData_x_dalpha.IA < 1.0*to_rad+ALPHA_tol_x_dalpha;
idx_x_dalpha.ALPHA_6 = 6.0*to_rad-ALPHA_tol_x_dalpha < TData_x_dalpha.IA & TData_x_dalpha.IA < 2.0*to_rad+ALPHA_tol_x_dalpha;
...
% ub_dgamma = [100,100,0,100,100,0,0];
% 
% zeros_vec_dgamma = zeros(size(TData_x_dalpha.IA));
% ones_vec_dgamma  = ones(size(TData_x_dalpha.IA));
% 
% ALPHA_vec_dgamma = TData_x_dalpha.SA; 
% GAMMA_vec_dgamma = TData_x_dalpha.IA; 
% FY_vec_dgamma    = TData_x_dalpha.FY;
% FZ_vec_dgamma    = TData_x_dalpha.FZ;
% 
% figure('Name','Non so cosa sia', 'NumberTitle', 11 + last_fig_FX0)
% plot(ALPHA_vec_dgamma,FY_vec_dgamma);
% 
...
% 
% figure('Name','Fx0 vs Gamma', 'NumberTitle', 12 + last_fig_FX0)
% plot(ALPHA_vec_dgamma,TData_x_dalpha.FY,'o')
% hold on
% plot(ALPHA_vec_dgamma,FY0_varGamma_vec,'-')
% xlabel('$\kappa$ [-]')
% ylabel('$F_{x0}$ [N]')
...
% tmp_ones_dgamma = ones(size(SA_vec));
% 
% FY0_gamma_var_vec1 = MF96_FY0_vec(tmp_zeros_dgamma, SA_vec ,mean(ALPHA_0_dalpha.IA)*tmp_ones_dgamma, mean(TData_x_dalpha.FZ)*tmp_ones_dgamma,tyre_coeffs_pl);
% FY0_gamma_var_vec2 = MF96_FY0_vec(tmp_zeros_dgamma, SA_vec ,mean(ALPHA_3_dalpha.IA)*tmp_ones_dgamma, mean(TData_x_dalpha.FZ)*tmp_ones_dgamma,tyre_coeffs_pl);
% FY0_gamma_var_vec3 = MF96_FY0_vec(tmp_zeros_dgamma, SA_vec ,mean(ALPHA_6_dalpha.IA)*tmp_ones_dgamma, mean(TData_x_dalpha.FZ)*tmp_ones_dgamma,tyre_coeffs_pl);
% FY0_gamma_var_vec4 = MF96_FY0_vec(tmp_zeros_dgamma, SA_vec ,mean(GAMMA_3_dgamma.IA)*tmp_ones_dgamma, mean(TData_x_dalpha.FZ)*tmp_ones_dgamma,tyre_coeffs_pl);
% FY0_gamma_var_vec5 = MF96_FY0_vec(tmp_zeros_dgamma, SA_vec ,mean(GAMMA_4_dgamma.IA)*tmp_ones_dgamma, mean(TData_x_dalpha.FZ)*tmp_ones_dgamma,tyre_coeffs_pl);
% 
% 
% figure('Name','Last fig','NumberTitle', 13 + last_fig_FX0)
% hold on
% plot(ALPHA_0_dalpha.SA*to_deg,ALPHA_0_dalpha.FY,'.','MarkerSize',5) %'MarkerEdgeColor','y',
% plot(ALPHA_3_dalpha.SA*to_deg,ALPHA_3_dalpha.FY,'.','MarkerSize',5) %'MarkerEdgeColor','c',
% plot(ALPHA_6_dalpha.SA*to_deg,ALPHA_6_dalpha.FY,'.','MarkerSize',5) %'MarkerEdgeColor','m',
% plot(GAMMA_3_dgamma.SA*to_deg,GAMMA_3_dgamma.FY,'.','MarkerSize',5) %'MarkerEdgeColor','b',
% plot(GAMMA_4_dgamma.SA*to_deg,GAMMA_4_dgamma.FY,'.','MarkerSize',5) %'MarkerEdgeColor','r',
% plot(SA_vec*to_deg,FY0_gamma_var_vec1,'-s','LineWidth',2,'MarkerSize',1)
% plot(SA_vec*to_deg,FY0_gamma_var_vec2,'-s','LineWidth',2,'MarkerSize',1)
